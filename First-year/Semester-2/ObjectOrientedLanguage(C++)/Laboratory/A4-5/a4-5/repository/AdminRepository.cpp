...
DynamicArray<class Dog>& RepoAdmin::getRepoDogs() {
    /*
...
bool RepoAdmin :: addRepoDog(class Dog& dog) {
    /*
...
bool RepoAdmin::updateRepoDog(class Dog& dog, const string& name, const string& breed, int age) {
    /*
